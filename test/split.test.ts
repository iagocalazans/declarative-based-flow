import { ACTIONS, Flow, flow } from "../src";

interface NumberStringValuePayload {
  payload: { value: string | number };
}

const destination = {
  success: (next: Flow<NumberStringValuePayload, NumberStringValuePayload>) =>
    next.setVariable("path", "success"),
  failed: (next: Flow<NumberStringValuePayload, NumberStringValuePayload>) =>
    next.setVariable("path", "failed"),
};
